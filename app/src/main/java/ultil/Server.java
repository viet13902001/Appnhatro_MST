...
//    public static String localhost = "192.168.1.102";
    ...
    public static String Duongdansanpham ="http://"+ localhost+ "/server/getspsearch.php";
    public static String Duongdansanphamsearch ="http://"+ localhost+ "/server/getResultSearch.php?page=1";
