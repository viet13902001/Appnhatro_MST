...
public class SearchAdapter extends BaseAdapter {
    ...
    public SearchAdapter(Context context, ArrayList<Sanpham> arrayhotel) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            ...
            convertView = inflater.inflate(R.layout.dong_search,null);
            viewHolder.txttenhotel= convertView.findViewById(R.id.textviewsearch);
            viewHolder.txtgiahotel= convertView.findViewById(R.id.textviewgiasearch);
            viewHolder.txtmotahotel= convertView.findViewById(R.id.textviewmotasearch);
            viewHolder.imghotel= convertView.findViewById(R.id.imagesearch);
